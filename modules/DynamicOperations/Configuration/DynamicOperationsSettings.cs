    ...
    internal sealed class DynamicOperationsSettings
    {
        ...
        public DynamicOperationsSettings(ConfigFile config)
        {
            Enabled = config.Bind("DynamicOperations", "Enabled", false,
                "Experimental secondary missions: capture, defend and interdiction; server-owned money, XP and battlefield rewards. Requires an in-game validation pass. Restart after changing. MIS > SECONDARY requires Command.ExpandedMapUi.");

...
Scope edits to this folder and `tests/BoscaliSummer.Tests/Features/Radio`. This module owns
local library discovery, starter stations, playback, vanilla-music handoff, MFD UI, icons,
assets, and its Harmony patches.

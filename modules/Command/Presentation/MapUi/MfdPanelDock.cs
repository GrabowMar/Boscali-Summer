...
namespace BoscaliSummer.Features.Command.Presentation.MapUi
{
    ...
    internal static class MfdPanelDock
    {
        ...
        public static void CloseOthers(VirtualMFD mfd, MFDScreen opening)
        {
            ...
            CloseOthersIn(MapUiAccess.GetLeftScreens(mfd), opening, left: true);
            CloseOthersIn(MapUiAccess.GetRightScreens(mfd), opening, left: false);
        }
        ...
        public static void Reset()
        {
            ...
            MfdPresentation.Restore();
            Restore();
            if (dock != null) Object.Destroy(dock.gameObject);
            dock = null;
        }
    }
}

...
Copy-Item -LiteralPath "$repo/modules/Command/Presentation/MapUi/SettingsMfdPanel.cs", "$repo/modules/Command/Presentation/MapUi/SettingsServerPage.cs", "$repo/modules/Command/Presentation/MapUi/SettingsChoices.cs", "$repo/modules/Command/Presentation/MapUi/MapMfdLookup.cs", "$repo/modules/Command/Presentation/MapUi/MfdLayout.cs", "$repo/modules/Command/Configuration/CommandSettings.cs", "$repo/Framework/Contracts/IHostSettingsView.cs", "$repo/Framework/Contracts/ISecondaryObjectivesView.cs", "$repo/Framework/Features/HostSettingsBoard.cs", "$PSScriptRoot/SettingsUnityCheck.cs", "$PSScriptRoot/SettingsUnityStubs.cs" -Destination "$PreviewDirectory/Assets/"

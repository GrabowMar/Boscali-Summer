...
Copy-Item -LiteralPath "$repo/modules/Command/Presentation/MapUi/SettingsMfdPanel.cs", "$repo/modules/Command/Presentation/MapUi/SettingsChoices.cs", "$repo/modules/Command/Presentation/MapUi/MapMfdLookup.cs", "$repo/modules/Command/Presentation/MapUi/MfdLayout.cs", "$repo/modules/Command/Configuration/CommandSettings.cs", "$PSScriptRoot/SettingsUnityCheck.cs", "$PSScriptRoot/SettingsUnityStubs.cs" -Destination "$PreviewDirectory/Assets/"

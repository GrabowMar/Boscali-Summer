...
Copy-Item -LiteralPath "$repo/modules/UrbanCombat/Runtime/RooftopPlacement.cs", "$repo/modules/UrbanCombat/Visuals/OccupiedBuildingMarking.cs", "$repo/modules/UrbanCombat/Visuals/GarrisonVisual.cs" -Destination "$PreviewDirectory/Assets/"

...
namespace BoscaliSummer.Tests.Features.UrbanCombat
{
    internal static class TroopDeploymentTests
    {
        public static void Run()
        {
            ...
            // Visible sentries scale with the committed force but stay bounded.
            TestAssert.That(TroopDeploymentMath.ComputeVisibleSentries(16) == 8,
                "16 committed troops show 8 sentries");
            TestAssert.That(TroopDeploymentMath.ComputeVisibleSentries(2) == 2,
                "two sentries is the floor");
            TestAssert.That(TroopDeploymentMath.ComputeVisibleSentries(64) == 8,
                "visible sentries are capped");
        }
    }
}

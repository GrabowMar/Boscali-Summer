...
Copy-Item -LiteralPath "$PSScriptRoot/TrenchUnityCheck.cs", "$repo/modules/Trenches/Visuals/TrenchMeshBuilder.cs", "$repo/modules/Trenches/Visuals/TrenchMaterialResolver.cs", "$repo/modules/Trenches/Visuals/TrenchPrefabResolver.cs" -Destination "$PreviewDirectory/Assets/"

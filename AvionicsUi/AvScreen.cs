...
namespace NOAvionics.Ui
{
    ...
    public sealed class AvScreen
    {
            ...
            int chipCount, float width, float height, Action<int> onTab)
        {
            ...
            shell.Add(AvBox.Cell("body").Grow())
            ...
            RectTransform parent, Rect body, float contentHeight, out Rect contentArea)
        {
            ...
            // Four pixels for the thumb, eight for breathing room beside trailing values.
        ...
        /// <summary>
        /// The strip's copy, in priority order: the hovered control, an armed-map prompt,
        /// then an alert and ambient telemetry. Interaction feedback wins while the player
        /// is acting; persistent alerts remain visible in the data bar and return on idle.
        /// </summary>

...
- **Dynamic trenches (experimental)** — frontline sector belts chained along faction-owned
  border sides on dry, buildable ground. A 132m fire-trench line grows into a layered belt
  (support line, dugout, rear redoubt, flank weapon pits, up to ±176m wide and 116m deep)
  with up to six native MG/AT/AA defenders spread along it (96 total). Hits pause
  construction for a minute; lost defenders stay lost. Requires Command. Vanilla combat
  units replicate; procedural earthworks and trench map marks remain host-local.
